package by.wawan.Spring.controller;

import by.wawan.Spring.dto.NewPersonDto;
import by.wawan.Spring.exeption.NoSuchEntityException;
import by.wawan.Spring.form.PersonForm;
import by.wawan.Spring.entity.Person;
import by.wawan.Spring.service.PersonService;
    ...
    public ModelAndView savePerson(Model model, //
        ...
        if (errors.hasErrors()) {
           ...
           // Date birthday = (Date)personDto.getBirthday();
            ...
            Person newPerson = new Person(id, firstName, lastName, street,city, zip, email, phone);
